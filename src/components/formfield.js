  ...
  render() {
    return(
      <div className="form-group">
        ...
        <input type={this.props.type} className="form-control" id={this.props.id} aria-describedby={this.props.aria} placeholder={this.props.placeholder}/>
        <small id={this.props.aria} className="form-text text-muted">{this.props.smalltext}</small>
      </div>
