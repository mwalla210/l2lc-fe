 ...
 * @param {Boolean} [required] Indicates whether the task is required
 * @param {String} title Title of the task
 * @param {?String} [processArea] Process area associated with the task
 * @param {String} id ID of the task
 * @param {Boolean} [required] Indicates whether the task is required [observable]
 * @param {String} title Title of the task [observable]
 * @param {?String} [processArea] Process area associated with the task [observable]
